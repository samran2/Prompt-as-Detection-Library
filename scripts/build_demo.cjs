...
const PUBLIC_FILES = Object.freeze(['index.html', 'style.css', 'workbench.css', 'catalog.js', 'atlas-catalog.js', 'd3fend-catalog.js', 'environment.js', 'environment-ui.js', 'core.js', 'defenses.js', 'defenses-ui.js', 'app.js', 'workbench-ui.js', 'workspace.js', 'workspace-store.js', 'workspace-ui.js', 'research-components.js', 'research-sources.js', 'research-mappings.js', 'research.html', 'research.css', 'research.js', 'navigator.js', 'car-catalog.js', 'car.js', 'attack-flow.js', 'robustness.js', 'lab-exchange.js', 'favicon.svg', 'THIRD_PARTY_LICENSE.txt', 'ATLAS_LICENSE.txt', 'D3FEND_LICENSE.txt', 'RESEARCH_SOURCES_LICENSES.txt', '.nojekyll']);
